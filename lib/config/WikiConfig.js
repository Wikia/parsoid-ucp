...
function WikiConfig(parsoidConfig, resultConf, prefix) {
	...
	mwApiConf.extensions = this.getExtensions(isGamepedia);
...
/**
 * Get proper extensions to load
 * @param {boolean} isGamepedia
 * @return {Array}
 */
WikiConfig.prototype.getExtensions = function(isGamepedia) {
