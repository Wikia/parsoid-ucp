 ...
 * @param {MWParserEnvironment} env
 */
var SiteInfoRequest = function(env, formatversion) {
	ApiRequest.call(this, env, null);
	this.queueKey = env.conf.wiki.apiURI;
	this.reqType = "Site Info Request";
...
util.inherits(SiteInfoRequest, ApiRequest);

// Function which returns a promise for the result of a site info request.
SiteInfoRequest.promise = promiseFor(SiteInfoRequest);
...
if (typeof module === "object") {
	...
	module.exports.SiteInfoRequest = SiteInfoRequest;
